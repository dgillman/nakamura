...
public class DefaultResourceSearchBatchResultWriter implements
    SolrSearchBatchResultWriter {

  private static final Logger LOGGER = LoggerFactory.getLogger(DefaultResourceSearchBatchResultWriter.class);

  /**
   * Component Constructor.
   */
  public DefaultResourceSearchBatchResultWriter() {
  }
