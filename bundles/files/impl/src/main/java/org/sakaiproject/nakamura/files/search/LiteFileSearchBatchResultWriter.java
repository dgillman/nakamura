...
public class LiteFileSearchBatchResultWriter implements SolrSearchBatchResultWriter {

  public static final Logger LOGGER = LoggerFactory
      .getLogger(LiteFileSearchBatchResultWriter.class);
  ...
  public LiteFileSearchBatchResultWriter(ProfileService profileService) {
    this.profileService = profileService;
  }

  public LiteFileSearchBatchResultWriter() {
  }
