...
export JAVA_OPTS="-Dfile.encoding=UTF8 -server -Xmx1024m -XX:MaxPermSize=512m -Djava.awt.headless=true -Dsun.lang.ClassLoader.allowArraySyntax=true -Dorg.apache.jasper.compiler.Parser.STRICT_QUOTE_ESCAPING=false -Dsakai.demo=true -Dsakai.cookieName=SAKAI2SESSIONID"
export K2_OPTS="-Dfile.encoding=UTF8 -server -Xmx1024m -XX:MaxPermSize=256m -Djava.awt.headless=true"
BUILD_DATE=`date "+%D %R"`
